# -*- coding: utf-8 -*-
# @Time : 2021/7/19 18:02
# @Author : Jiang Yongzheng
# coding=utf-8
import os
import argparse
import datetime
...
print("Environment===>>>{}".format(os.system('env')))
...
if __name__ == '__main__':
    ...
    os.system('pip install tensorflow-hub==0.2.0')
    os.system('pip install h5py==2.8.0')
    os.system("python ./code/ELMO-BCN/eval.py")
